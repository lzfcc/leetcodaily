function Position(line, column) {
    this.line = line;
    this.column = column;
    this.validate = function(pos) {
        return pos && (this.line > pos.line || (this.line == pos.line && this.column > pos.column + 2));
    }
}
...
//         let lineArr = source[line].split('');
//         let lc = false; 
//         for (let i = 0; i < lineArr.length - 1; i++) {
//             if (lineArr[i] == '/') {
//                 if (lineArr[i + 1] == '/') {
//                     if (!blockStart) {
//                         lineArr.splice(i);   //remove characters from i in current line
//                         break;   
//                     }
//                 } else if (lineArr[i + 1] == '*') {
//                     if (!blockStart) {
//                         blockStart = new Position(line, i);
//                     }
//                 } else {
//                     //do nothing...
//                 }
//             } else if (lineArr[i] == '*') {
//                 if (lineArr[i + 1] == '/') {
//                     let blockEnd = new Position(line, i + 1);
//                     if (blockEnd.validate(blockStart)) {
//                         if (blockEnd.line == blockStart.line) {
//                             lineArr.splice(blockStart.column, blockEnd.column - blockStart.column + 1);
//                             i = blockStart.column - 1;
//                         } else {
//                             let startline = res.length - (blockEnd.line - blockStart.line);
//                             let content = res[startline];
//                             content.splice(blockStart.column)
//                             res.splice(startline);
//                             lineArr.splice(0, blockEnd.column + 1)
//                             lineArr = content.concat(lineArr);
//                         }
//                         blockStart = null;
//                     } else {
//                         //do nothing...
